...
Route::prefix('forms/cpr/employee')->group(function () {
  Route::get('/', [CprEmployeeController::class, 'index'])->name('employee.index');
  Route::post('/store', [CprEmployeeController::class, 'store'])->name('employee.store');
  Route::delete('/{id}/delete', [CprEmployeeController::class, 'destroy'])->name('employee.destroy');
});
